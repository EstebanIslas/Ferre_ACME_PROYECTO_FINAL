...
public class ControllerProveedores implements KeyListener {
    ...
    public ControllerProveedores(ModelProveedores modelProveedores, ViewProveedores viewProveedores) {
        ...
        this.viewProveedores.jtb_tabla_proveedores.addMouseListener(mouseListener);
        setActionListener();
        initComponets();
        inicioCrud();
    }
    ...
    public void llenarTabla() {
        ...
        viewProveedores.jtb_tabla_proveedores.setModel(modelProveedores.getModelo());
        modelProveedores.agregaraTabla();
    ...
    MouseListener mouseListener = new MouseListener() {
        ...
        public void mouseClicked(MouseEvent e) {
            if (e.getSource() == viewProveedores.jtb_tabla_proveedores) {
                int seleccion = viewProveedores.jtb_tabla_proveedores.getSelectedRow();

                viewProveedores.jtf_proveedor_id.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 0)));
                viewProveedores.jtf_nombre.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 1)));
                viewProveedores.jtf_apellido_paterno.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 2)));
                viewProveedores.jtf_apellido_materno.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 3)));
                viewProveedores.jtf_empresa.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 4)));
                viewProveedores.jtf_telefono.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 5)));
                viewProveedores.jtf_calle.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 6)));
                viewProveedores.jtf_numero.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 7)));
                viewProveedores.jtf_colonia.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 8)));
                viewProveedores.jtf_codigo_postal.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 9)));
                viewProveedores.jtf_email.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 10)));
                viewProveedores.jtf_ciudad.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 11)));
                viewProveedores.jtf_estado.setText(String.valueOf(viewProveedores.jtb_tabla_proveedores.getValueAt(seleccion, 12)));
            }
        }
